...
{
    public class CreditCardIssuingBankDAO : IUserInterfaceSupportDAO<CreditCardIssuingBankDTO>
    {
        ...
        public List<CreditCardIssuingBankDTO> GetAllRecords()
        {
            ...
            try
            {
                ...
                string strSQL = "SELECT * FROM CreditCardIssuingBank;";
                ...
                if (objDR.HasRows)
                {
                    ...
                    List<CreditCardIssuingBankDTO> colRecordList = new List<CreditCardIssuingBankDTO>();

                    //Step 10-Loop through the Collection to Add Data Transfer Object
                    while (objDR.Read())
                    {
                        //10a-Create Data Transfer Object
                        CreditCardIssuingBankDTO objDTO = new CreditCardIssuingBankDTO();
                        ...
                        objDTO.CreditCardIssuingBankCode = objDR.GetByte(0);
                        objDTO.CreditCardIssuingBankName = objDR.GetString(1);
            ...
            catch (Exception objE)
            {
                ...
                throw new Exception("Unexpected Error in CreditCardIssuingBankDAO " +
