...
{
   public class CreditCardCorporateMerchantBankDAO : IUserInterfaceSupportDAO<CreditCardCorporateMerchantBankDTO>
    {
        ...
        //Purpose:      Method that retrieve all CreditCardCorporateMerchantBank 
        //              Records from the CreditCardCorporateMerchantBank TABLE in
        ...
        public List<CreditCardCorporateMerchantBankDTO> GetAllRecords()
        {
            ...
            try
            {
                ...
                string strSQL = "SELECT * FROM CreditCardCorporateMerchantBank;";
                ...
                if (objDR.HasRows)
                {
                    ...
                    List<CreditCardCorporateMerchantBankDTO> colRecordList = new List<CreditCardCorporateMerchantBankDTO>();

                    //Step 10-Loop through the Collection to Add Data Transfer Object
                    while (objDR.Read())
                    {
                        //10a-Create Data Transfer Object
                        CreditCardCorporateMerchantBankDTO objDTO = new CreditCardCorporateMerchantBankDTO();
                        ...
                        objDTO.CreditCardCorporateMerchantBankCode = objDR.GetByte(0);
                        objDTO.CreditCardCorporateMerchantBankName = objDR.GetString(1);
            ...
            catch (Exception objE)
            {
                ...
                throw new Exception("Unexpected Error in CreditCardCorporateMerchantBankDAO " +
