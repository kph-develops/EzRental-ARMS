...
{
    public class CreditCardProcessingMerchantServiceCompanyDAO : IUserInterfaceSupportDAO<CreditCardProcessingMerchantServiceCompanyDTO>
    {
        ...
        //Purpose:      Method that retrieve all CreditCardProcessingMerchantServiceCompany 
        //              Records from the CreditCardProcessingMerchantServiceCompany TABLE in
        ...
        public List<CreditCardProcessingMerchantServiceCompanyDTO> GetAllRecords()
        {
            ...
            try
            {
                ...
                string strSQL = "SELECT * FROM CreditCardProcessingMerchantServiceCompany;";
                ...
                if (objDR.HasRows)
                {
                    ...
                    List<CreditCardProcessingMerchantServiceCompanyDTO> colRecordList = new List<CreditCardProcessingMerchantServiceCompanyDTO>();

                    //Step 10-Loop through the Collection to Add Data Transfer Object
                    while (objDR.Read())
                    {
                        //10a-Create Data Transfer Object
                        CreditCardProcessingMerchantServiceCompanyDTO objDTO = new CreditCardProcessingMerchantServiceCompanyDTO();
                        ...
                        objDTO.CreditCardProcessingMerchantServiceCompanyCode = objDR.GetByte(0);
                        objDTO.CreditCardProcessingMerchantServiceCompanyName = objDR.GetString(1);
            ...
            catch (Exception objE)
            {
                ...
                throw new Exception("Unexpected Error in CreditCardProcessingMerchantServiceCompanyDAO " +
